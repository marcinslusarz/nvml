...
+ **PMEM_MEM_NONTEMPORAL** - Use non-temporal instructions.
  This flag is mututally exclusive with **PMEM_MEM_TEMPORAL**.
...
+ **PMEM_MEM_NOCACHE** - Bypass CPU caches.
  This flag is mutually exclusive with **PMEM_MEM_CACHE**.
  On x86\_64 this is an alias for **PMEM_MEM_NONTEMPORAL**.
  On x86\_64 this flag is mutually exclusive with **PMEM_MEM_NOFLUSH**.

+ **PMEM_MEM_CACHE** - Use CPU caches.
  This flag is mutually exclusive with **PMEM_MEM_NOCACHE**.
